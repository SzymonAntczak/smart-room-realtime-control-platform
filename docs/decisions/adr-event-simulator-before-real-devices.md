...
The simulator must represent the same event and command contracts as real
...
The simulator should emit realistic events, accept commands and model common
edge cases such as latency, explicit failures, stale data, offline periods and
recovery.
