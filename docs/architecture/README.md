...
| [AI collaboration model](ai-collaboration.md)         | Source-of-truth hierarchy plus the preferred AI delivery workflow, task-difficulty and model-selection guidance, and subagent research boundaries. |
